...
aoi_list = ["ambikapur", "attur", "badravati", "beed", "dimapur", "hubli", "kumarghat", 
            "moga", "morvi", "ramgarh", "sangli", "tiruchchendur", "udhampur", "yavatmal"]
...
if __name__ == "__main__":
    ...
    for aoi in aoi_list:
        ...
        images_dir = "/Users/pradip.gupta/jiogis/data/datasets/raw_data/"
